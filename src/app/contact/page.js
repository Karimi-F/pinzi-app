...
export default function Contact() {
    return (
        ...
        <div className="p-4 w-1/4">
          ...
          <div className="p-4">
          <h4 className="cursor-pointer hover:text-red-500">Terms of Service</h4>
        ...
        <div className="p-4 w-1/4">
          ...
          <h4 className="cursor-pointer hover:text-red-500"><Github /></h4>
          <h4 className="cursor-pointer hover:text-red-500"><Twitter /></h4>
          <h4 className="cursor-pointer hover:text-red-500"><Mail /></h4>  
          </div>
        </div>
      </div>
